...
options(
  cingulate.llm.backend = "ollama",
  cingulate.llm.temperature = 0.2,
  cingulate.llm.model_override = NULL
)
...
options(
  cingulate.skip_if_exists = TRUE,
  cingulate.verbose = FALSE,
  cingulate.tables.pdf = FALSE
)
...
preferred_sans <- c("Equity B", "IBM Plex Sans", "Source Sans 3", "Helvetica")
preferred_serif <- c(
  "Equity B",
  "IBM Plex Serif",
  "Source Serif 4"
...
::: {.content-visible when-meta="include_appendix"}
